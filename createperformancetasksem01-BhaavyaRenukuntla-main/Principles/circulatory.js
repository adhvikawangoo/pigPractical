...
let questions = [
    ...
    {
        prompt: `The movement of blood through the heart and body is called:`,
        options: [
            "Circulation",
            "Locomotion",
            "Ventriculation",
    ...
    {
        prompt: `The beating sound your heart makes comes from:`,
        options: [
    ...
    {
        prompt: `With circulation, the heart provides your body with:`,
        options: [
            "Oxygen",
            "Nutrients",
    ...
    {
        prompt: `The atria are the “upstairs” chambers of the heart and these parts are the “downstairs” chambers`,
        options: [
            "Valves",
            "Ventricles",
            "Blood",
