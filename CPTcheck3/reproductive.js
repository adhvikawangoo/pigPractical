...
let questions = [
    {
        prompt: `What part of the female reproductive system handles the
fertilization of eggs`,
    ...
    {
        prompt: `how many trimesters of pregnancy are there`,
        options: [
            "four",
            "six",
            "three",
    ...
    {
        prompt: `How many inches dialated should the cervix be for delivery?`,
        options: [
            "10",
            "13",
"5",
"12"
    ...
    {
        prompt: `What part of the male reproductive system is tied in a vasectomy?`,
        options: [
            "the testes",
            "The Vas Deferens",
        ],
